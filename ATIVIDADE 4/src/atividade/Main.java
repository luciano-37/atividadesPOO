...
public class Main {
	public static void main(String[] args) {
        ...
        Gerente gerente = new Gerente(35,"luciano","757575757575","Gerente Regional",5525.50, 0.15,"Norte-",0); //Criando gerente
        Vendedor vendedor = new Vendedor(25,"Maria","12121131313","Vendedor Interno", 1550.50, gerente,0,0.05,0);//Criando vendedor
        Vendedor vendedor2 = new Vendedor(25,"joana","12343231112212","Vendedor Externo", 1550.50, gerente,0,0.05,0);//Criando outro vendedor
